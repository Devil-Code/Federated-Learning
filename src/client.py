...
class Client(fl.client.NumPyClient):
    ...
    def fit(
        ...
        self.model = utils.train(self.model, self.trainloader, self.valloader, self.num_examples, args.partition, 
                                 device, args.log_interval, epochs=args.epochs, es_patience=3)
    ...
    def evaluate(
        ...
        self.set_parameters(parameters)
        loss, auc, accuracy, f1 = utils.val(self.model, self.testloader, nn.BCEWithLogitsLoss(), f"_test", device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", type=str, default="/home/gandhi/Project/decentralizedAI_dermatology/archive")
